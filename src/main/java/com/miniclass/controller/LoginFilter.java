...
public class LoginFilter extends BaseController implements Filter{
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        // url特殊处理：不放行url
        if ( ( url.contains("showUserClass.j") || url.contains("showOneClass.j") || url.endsWith("my.j") || url.contains("showOneTip.j") || url.contains("showOnePPT.j") || url.contains("showShare.j") || url.contains("showHero.j") || url.contains("showOneExam.j")) &&  (null == userId) ){
